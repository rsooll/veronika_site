...
function helpArticles() {
    ...
    let allImg = [
        ...
        '<a href="../articles/9-Порядок раздела имущества, совместно нажитого супругами в период брака.html"  alt="ArticleIMG"><div class="lawArticle"> <img class="ArticleIMG" src="../assets/img/articles/9-blog.webp"></img> <p class="lawArticleName">Порядок раздела имущества, совместно нажитого супругами в период брака</p> </div></a>',
        '<a href="../articles/10-Рекомендации по заключению договора займа.html"  alt="ArticleIMG"><div class="lawArticle"> <img class="ArticleIMG" src="../assets/img/articles/10-blog.webp"></img> <p class="lawArticleName">Рекомендации по заключению договора займа</p> </div></a>'
    ];
